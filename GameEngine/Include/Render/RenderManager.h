...
private:
	...
	CSharedPtr<class CShader>		m_EffectShader;

	CSharedPtr<CTexture>			m_VelocityMapTexture;
	CSharedPtr<CRenderTarget>		m_VelocityMapTarget;
	CSharedPtr<class CShader>		m_VelocityCreateShader;

	CSharedPtr<CRenderTarget>		m_BlurMapTarget;
