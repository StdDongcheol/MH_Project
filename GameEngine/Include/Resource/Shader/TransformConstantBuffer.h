...
public:
	...
	void SetPrevWorldMatrix(const Matrix& matPrevWorld)
	{
		m_BufferData.matPrevWorld = matPrevWorld;
	}
	
	void SetPrevViewMatrix(const Matrix& matPrevView)
	{
		m_BufferData.matPrevView = matPrevView;
	}
