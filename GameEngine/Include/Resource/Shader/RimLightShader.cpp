...
bool CRimLightShader::Init()
{
	if (!LoadVertexShader("RimLightVS", TEXT("RimLight.fx"), SHADER_PATH))
		return false;

	if (!LoadPixelShader("RimLightPS", TEXT("RimLight.fx"), SHADER_PATH))
		return false;
