...
bool CIMGUIManager::Init(HWND hWnd)
{
	...
	io.DisplaySize.x = (float)CDevice::GetInst()->GetResolution().Width;
	io.DisplaySize.y = (float)CDevice::GetInst()->GetResolution().Height;
