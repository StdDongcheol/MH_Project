...
void CStaticMeshComponent::SetRenderStateAll(const std::string& Name)
{
	size_t Size = m_vecMaterialSlot.size();

	for (size_t i = 0; i < Size; ++i)
	{
		m_vecMaterialSlot[i]->SetRenderState(Name);
	}
}
...
void CStaticMeshComponent::SetOpacityAll(float Opacity)
{
	size_t Size = m_vecMaterialSlot.size();
...
void CStaticMeshComponent::RenderVelocityMap()
{
