...
CMesh* CSceneResource::FindMesh(const std::string& Name)
{
	...
	return CResourceManager::GetInst()->FindMesh(Name);
}
...
void CSceneResource::UpdateVertex(const std::string& Name, void* Data, UINT Size)
{
...
CShader* CSceneResource::FindShader(const std::string& Name)
{
	...
	return CResourceManager::GetInst()->FindShader(Name);
}
...
CMaterial* CSceneResource::FindMaterial(const std::string& Name)
{
	...
	return CResourceManager::GetInst()->FindMaterial(Name);
}
...
CTexture* CSceneResource::FindTexture(const std::string& Name)
{
	...
	return CResourceManager::GetInst()->FindTexture(Name);
}
...
CAnimationSequence2D* CSceneResource::FindAnimationSequence2D(const std::string& Name)
{
	...
	return CResourceManager::GetInst()->FindAnimationSequence2D(Name);
}
...
bool CSceneResource::SoundPlay(const std::string& Name, class CGameObject* Obj)
{
	return CResourceManager::GetInst()->SoundPlay(Name, Obj);
}
...
CSound* CSceneResource::FindSound(const std::string& Name)
{
	...
	return CResourceManager::GetInst()->FindSound(Name);
}
...
CParticle* CSceneResource::FindParticle(const std::string& Name)
{
	...
	return CResourceManager::GetInst()->FindParticle(Name);;
}
...
CAnimationSequence* CSceneResource::FindAnimationSequence(const std::string& Name)
{
	...
	return CResourceManager::GetInst()->FindAnimationSequence(Name);;
}
...
CSkeleton* CSceneResource::FindSkeleton(const std::string& Name)
{
	...
	return CResourceManager::GetInst()->FindSkeleton(Name);;
}
