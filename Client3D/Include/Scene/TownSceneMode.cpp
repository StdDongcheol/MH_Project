...
CTownSceneMode::CTownSceneMode()	:
	m_First(false)
{
	SetTypeID<CTownSceneMode>();
...
void CTownSceneMode::Start()
{
	if (CObjectManager::GetInst()->GetCheckType() == Check_Type::LoadingToStage)
	{
...
bool CTownSceneMode::Init()
{
	...
	//m_Scene->GetViewport()->CreateWidgetWindow<CQuestWindow>("QuestWindow");
...
void CTownSceneMode::Update(float DeltaTime)
{
	...
	if (!m_First)
	{
		...
		CResourceManager::GetInst()->SoundPlay("TownBGM");
	}
}

const CharacterInfo* CTownSceneMode::GetCharacterInfo(const std::string& CharacterName) const
{
	size_t Size = m_vecObjectInfo.size();
...
void CTownSceneMode::CreateMaterial()
{
...
void CTownSceneMode::CreateAnimationSequence()
{
}

void CTownSceneMode::CreateBillboardSequence()
{
...
void CTownSceneMode::CreateParticle()
{
...
void CTownSceneMode::AddWeaponSocket()
{
...
void CTownSceneMode::AddMonsterSocket()
{
	//바르노스
...
void CTownSceneMode::AddLargeMonsterSocket()
{
	// Rathalos
...
void CTownSceneMode::CreateSequence(const std::string& Name, const TCHAR* FileName, int CountX, int CountY, float SizeX, float SizeY)
{
...
void CTownSceneMode::AddLandScape(std::vector<TCHAR*>& vec, const TCHAR* Path)
{
...
void CTownSceneMode::SetLandScape(int Register, const std::string& Name, std::vector<TCHAR*>& vecFileName, const std::string& PathName)
{
	CMaterial* Material = m_Scene->GetResource()->FindMaterial("LandScape");
